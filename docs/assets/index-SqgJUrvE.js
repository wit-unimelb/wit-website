...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Tl(e,t,n){let r=new Float32Array(dl),i=new W(0,1,0);return new Ks({name:`SphericalGaussianBlur`,defines:{n:dl,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ol(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function El(){return new Ks({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ol(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Dl(){return new Ks({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ol(),fragmentShader:`
	...
	`}var kl=class extends ta{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ms(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Qu={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function $u(e,t){let n=Qu[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ed=new W;function td(){return K.getLuminanceCoefficients(ed),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ed.x.toFixed(4)}, ${ed.y.toFixed(4)}, ${ed.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
#define LOW_PRECISION`),t}var gd={1:`SHADOWMAP_TYPE_PCF`,3:`SHADOWMAP_TYPE_VSM`};function _d(e){return gd[e.shadowMapType]||`SHADOWMAP_TYPE_BASIC`}var vd={301:`ENVMAP_TYPE_CUBE`,302:`ENVMAP_TYPE_CUBE`,306:`ENVMAP_TYPE_CUBE_UV`};function $(e){return e.envMap===!1?`ENVMAP_TYPE_CUBE`:vd[e.envMapMode]||`ENVMAP_TYPE_CUBE`}var yd={302:`ENVMAP_MODE_REFRACTION`};function bd(e){return e.envMap===!1?`ENVMAP_MODE_REFLECTION`:yd[e.envMapMode]||`ENVMAP_MODE_REFLECTION`}var xd={0:`ENVMAP_BLENDING_MULTIPLY`,1:`ENVMAP_BLENDING_MIX`,2:`ENVMAP_BLENDING_ADD`};function Sd(e){return e.envMap===!1?`ENVMAP_BLENDING_NONE`:xd[e.combine]||`ENVMAP_BLENDING_NONE`}function Cd(e){let t=e.envMapCubeUVHeight;if(t===null)return null;let n=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(2**n,112)),texelHeight:r,maxMip:n}}function wd(e,t,n,r){let i=e.getContext(),a=n.defines,o=n.vertexShader,s=n.fragmentShader,c=_d(n),l=$(n),u=bd(n),d=Sd(n),f=Cd(n),p=nd(n),m=rd(a),h=i.createProgram(),g,_,v=n.glslVersion?`#version `+n.glslVersion+`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Wu(i,i.VERTEX_SHADER,y),S=Wu(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Xu(i,x,`vertex`),n=Xu(i,S,`fragment`);H(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        }`}),y=new As(_,v);n.add(y),n.add(new jc(16777215,.7));let b=new Ac(16773365,1.4);b.position.set(2,4,5),n.add(b);let x=new Dc(s,1,10);x.position.set(-3,2,2),n.add(x);function S(){if(!t)return;let e=window.innerWidth,n=window.innerHeight;i.setSize(e,n),r.aspect=e/n,r.updateProjectionMatrix()}S(),window.addEventListener(`resize`,S);let C=!1,w=!1,T=0,E=0,D=0,O=0,ee=()=>{w=!0,t.style.cursor=`grab`},k=()=>{w=!1,t.style.cursor=`default`},A=e=>{C=!0,T=e.clientX,E=e.clientY,D=0,O=0,t.style.cursor=`grabbing`},te=e=>{C&&(O=(e.clientX-T)*.008,D=(e.clientY-E)*.008,a.rotation.y+=O,a.rotation.x+=D,T=e.clientX,E=e.clientY)},ne=()=>{C=!1,t.style.cursor=w?`grab`:`default`},re=e=>{C=!0,T=e.touches[0].clientX,E=e.touches[0].clientY,D=0,O=0},ie=e=>{C&&(O=(e.touches[0].clientX-T)*.008,D=(e.touches[0].clientY-E)*.008,a.rotation.y+=O,a.rotation.x+=D,T=e.touches[0].clientX,E=e.touches[0].clientY)},j=()=>{C=!1};t.addEventListener(`mouseenter`,ee),t.addEventListener(`mouseleave`,k),t.addEventListener(`mousedown`,A),window.addEventListener(`mousemove`,te),window.addEventListener(`mouseup`,ne),t.addEventListener(`touchstart`,re,{passive:!0}),window.addEventListener(`touchmove`,ie,{passive:!0}),window.addEventListener(`touchend`,j);let M=new Ic,N=0,ae;function oe(){ae=requestAnimationFrame(oe),M.update();let e=M.getElapsed();N=Math.min(N+.007,1);let t=N**1.8;v.uniforms.uTime.value=e,d.forEach(e=>{e.material.opacity=t}),f.forEach(e=>{e.material.opacity=t*.8}),C||(D*=.9,O*=.9,a.rotation.x+=D,a.rotation.y+=O,!w&&Math.abs(O)<.001&&(a.rotation.y+=.003)),a.position.y=1.1+Math.sin(e*.6)*.06,y.rotation.y=e*.05,i.render(n,r)}return oe(),()=>{cancelAnimationFrame(ae),i.dispose(),window.removeEventListener(`resize`,S),window.removeEventListener(`mousemove`,te),window.removeEventListener(`mouseup`,ne),window.removeEventListener(`touchmove`,ie),window.removeEventListener(`touchend`,j),t.removeEventListener(`mouseenter`,ee),t.removeEventListener(`mouseleave`,k),t.removeEventListener(`mousedown`,A),t.removeEventListener(`touchstart`,re)}},[]),(0,B.jsxs)(`section`,{className:`hero`,children:[(0,B.jsx)(`canvas`,{ref:e,className:`hero-canvas`}),(0,B.jsx)(`div`,{className:`hero-vignette`}),(0,B.jsxs)(`div`,{className:`hero-content`,children:[(0,B.jsx)(`div`,{className:`hero-eyebrow`,style:{marginTop:`200px`},children:`University of Melbourne · Est. 2013`}),(0,B.jsx)(`h1`,{className:`hero-title`,children:`WIT`}),(0,B.jsx)(`p`,{className:`hero-sub`,children:`Women in Technology`}),(0,B.jsxs)(`div`,{className:`hero-actions`,children:[(0,B.jsx)(`a`,{href:`https://umsu.unimelb.edu.au/buddy-up/clubs/clubs-listing/join/website/`,className:`btn-primary`,target:`_blank`,rel:`noopener noreferrer`,children:` Join Us`}),(0,B.jsxs)(`div`,{className:`hero-socials`,children:[(0,B.jsx)(`a`,{href:`https://discord.gg/mW5dg4dwcD`,target:`_blank`,rel:`noopener noreferrer`,className:`social-btn`,children:(0,B.jsx)(`img`,{src:`https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/discord.svg`,alt:`Discord`})}),(0,B.jsx)(`a`,{href:`https://umsu.unimelb.edu.au/buddy-up/clubs/clubs-listing/join/website/`,target:`_blank`,rel:`noopener noreferrer`,className:`social-btn`,children:(0,B.jsx)(`img`,{src:`https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/instagram.svg`,alt:`UMSU`})}),(0,B.jsx)(`a`,{href:`https://www.instagram.com/witunimelb/`,target:`_blank`,rel:`noopener noreferrer`,className:`social-btn`,children:(0,B.jsx)(`img`,{src:`https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/instagram.svg`,alt:`Instagram`})}),(0,B.jsx)(`a`,{href:`https://www.facebook.com/witunimelb`,target:`_blank`,rel:`noopener noreferrer`,className:`social-btn`,children:(0,B.jsx)(`img`,{src:`https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/facebook.svg`,alt:`Facebook`})})]})]})]}),(0,B.jsxs)(`div`,{className:`stats-strip`,children:[(0,B.jsxs)(`div`,{className:`stat`,children:[(0,B.jsx)(`div`,{className:`stat-num`,children:`500+`}),(0,B.jsx)(`div`,{className:`stat-label`,children:`Members`})]}),(0,B.jsxs)(`div`,{className:`stat`,children:[(0,B.jsx)(`div`,{className:`stat-num`,children:`30+`}),(0,B.jsx)(`div`,{className:`stat-label`,children:`Events / year`})]}),(0,B.jsxs)(`div`,{className:`stat`,children:[(0,B.jsx)(`div`,{className:`stat-num`,children:`20+`}),(0,B.jsx)(`div`,{className:`stat-label`,children:`Industry partners`})]})]})]})}var ff=[{title:`Community`,body:`A welcoming space for women and allies across every degree and year level. Find your people at our socials, workshops, and casual meetups.`,icon:(0,B.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:1.8,strokeLinecap:`round`,strokeLinejoin:`round`,children:[(0,B.jsx)(`path`,{d:`M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2`}),(0,B.jsx)(`circle`,{cx:`9`,cy:`7`,r:`4`}),(0,B.jsx)(`path`,{d:`M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75`})]})},{title:`Industry exposure`,body:`Panels, networking nights, and company visits that bridge the gap between uni and the industry roles you're working towards.`,icon:(0,B.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:1.8,strokeLinecap:`round`,strokeLinejoin:`round`,children:[(0,B.jsx)(`rect`,{x:`2`,y:`3`,width:`20`,height:`14`,rx:`2`}),(0,B.jsx)(`path`,{d:`M8 21h8M12 17v4`})]})},{title:`Leadership`,body:`Join our committee, lead subteams, and build real skills in events, design, media, promotions and more — all while still at uni.`,icon:(0,B.jsx)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:1.8,strokeLinecap:`round`,strokeLinejoin:`round`,children:(0,B.jsx)(`polygon`,{points:`12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2`})})}];function pf(){return(0,B.jsx)(`section`,{className:`pillars`,children:(0,B.jsxs)(`div`,{className:`pillars-inner`,children:[(0,B.jsx)(`p`,{className:`section-kicker`,children:`What we do`}),(0,B.jsxs)(`h2`,{className:`section-heading`,children:[`Community, `,(0,B.jsx)(`em`,{children:`culture`}),` & careers`]}),(0,B.jsx)(`div`,{className:`pillars-grid`,children:ff.map(e=>(0,B.jsxs)(`div`,{className:`pillar-card`,children:[(0,B.jsx)(`div`,{className:`pillar-icon`,children:e.icon}),(0,B.jsx)(`h3`,{children:e.title}),(0,B.jsx)(`p`,{children:e.body})]},e.title))})]})})}var mf=[`Airwallex`,`Macquarie`,`Jane Street`,`Fenwick`,`Atlassian`,`Australian Super`,`Susquehanna`,`CBA`,`Vanguard`,`Optiver`,`Accenture`,`PWC`,`Seek`,`EY`];function hf(){return(0,B.jsxs)(`div`,{className:`sponsors-row`,children:[(0,B.jsx)(`p`,{className:`sponsors-kicker`,children:`2026 Sponsors & Partners`}),(0,B.jsx)(`div`,{style:{overflow:`hidden`,padding:`0 40px`},children:(0,B.jsx)(`div`,{className:`marquee-track`,children:[...mf,...mf].map((e,t)=>(0,B.jsx)(`span`,{className:`sponsor-pill`,children:e},t))})})]})}function gf(){return(0,B.jsxs)(`section`,{className:`join-cta`,children:[(0,B.jsxs)(`h2`,{children:[`Ready to `,(0,B.jsx)(`em`,{children:`get involved?`})]}),(0,B.jsx)(`p`,{children:`Membership is free and open to everyone at the University of Melbourne — regardless of degree or experience level.`}),(0,B.jsx)(`a`,{href:`#`,className:`btn-light`,children:`Become a member`})]})}function _f(){return(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(df,{}),(0,B.jsx)(pf,{}),(0,B.jsx)(hf,{}),(0,B.jsx)(gf,{})]})}var vf=`/assets/Vanguard-B04gxoKr.webp`,yf=`/assets/accenture-Dl_qiM-f.webp`,bf=`/assets/airwallex-CFDe4yEQ.webp`,xf=`/assets/atlassian-B29b_Qus.webp`,Sf=`/assets/australianSuper-BYliAjWQ.webp`,Cf=`/assets/cba-D0W1eBiU.webp`,wf=`data:image/webp;base64,`,Tf=`/assets/fenwick-C1iGP94t.webp`,Ef=`/assets/janeStreet-DUVSZamk.webp`,Df=`/assets/macquarie-dQCm3Btt.webp`,Of=`/assets/optiver-BDXK_9Yd.webp`,kf=`/assets/pwc-DisQZ6rJ.webp`,Af=`/assets/seek-jdijDAfQ.webp`,jf=`/assets/susquehanna-C6MoYo5b.webp`,Mf={platinum:[{name:`Airwallex`,logo:null,url:`https://www.airwallex.com/au`}],gold:[{name:`Macquarie`,logo:null,url:`https://www.macquarie.com.au/`},{name:`Jane Street`,logo:null,url:`https://www.janestreet.com/`},{name:`Fenwick`,logo:null,url:`https://www.fenwick.com.au/`},{name:`Atlassian`,logo:null,url:`https://www.atlassian.com/`},{name:`AustralianSuper`,logo:null,url:`https://www.australiansuper.com/`}],silver:[{name:`Susquehanna`,logo:null,logoMaxHeight:80,url:`https://sig.com/`},{name:`Commonwealth Bank of Australia (CBA)`,logo:`cba`,url:`https://www.commbank.com.au/`},{name:`Vanguard`,logo:null,url:`https://www.vanguard.com.au/corporate/`}],tailored:[{name:`Optiver`,logo:null,url:`https://optiver.com/`},{name:`Accenture`,logo:null,url:`https://www.accenture.com/au-en`},{name:`PWC`,logo:null,logoMaxHeight:70,url:`https://www.pwc.com.au/`},{name:`SEEK`,logo:null,url:`https://www.seek.com.au/`},{name:`Ernst & Young (EY)`,logo:`ey`,url:`https://www.ey.com/en_au`}]},Nf={platinum:`Platinum`,gold:`Gold`,silver:`Silver`,tailored:`Tailored`},Pf=Object.assign({"../assets/sponsors/Vanguard.webp":vf,"../assets/sponsors/accenture.webp":yf,"../assets/sponsors/airwallex.webp":bf,"../assets/sponsors/atlassian.webp":xf,"../assets/sponsors/australianSuper.webp":Sf,"../assets/sponsors/cba.webp":Cf,"../assets/sponsors/ey.webp":wf,"../assets/sponsors/fenwick.webp":Tf,"../assets/sponsors/janeStreet.webp":Ef,"../assets/sponsors/macquarie.webp":Df,"../assets/sponsors/optiver.webp":Of,"../assets/sponsors/pwc.webp":kf,"../assets/sponsors/seek.webp":Af,"../assets/sponsors/susquehanna.webp":jf});function Ff(e){return e.toLowerCase().replace(/[^a-z0-9]/g,``)}var If=Object.fromEntries(Object.entries(Pf).map(([e,t])=>[Ff((e.split(`/`).pop()??``).replace(/\.[^.]+$/,``)),t]));function Lf(e){return If[Ff(e.logo??e.name)]}function Rf(){return(0,B.jsx)(`section`,{className:`sponsors-page`,children:(0,B.jsxs)(`div`,{className:`sponsors-page-inner`,children:[(0,B.jsxs)(`div`,{className:`sponsors-header`,children:[(0,B.jsx)(`p`,{className:`section-kicker`,children:`Our Partners`}),(0,B.jsxs)(`h2`,{className:`section-heading`,children:[`2026 `,(0,B.jsx)(`em`,{children:`Sponsors`})]}),(0,B.jsx)(`p`,{className:`sponsors-lead`,children:`WiT is proudly supported by industry leaders who share our commitment to empowering women in technology.`})]}),Object.keys(Mf).map(e=>(0,B.jsxs)(`div`,{className:`sponsor-tier`,children:[(0,B.jsx)(`div`,{className:`tier-label`,children:(0,B.jsx)(`div`,{className:`tier-badge tier-badge--${e}`,children:Nf[e]})}),(0,B.jsx)(`div`,{className:`tier-grid tier-grid--${e}`,children:Mf[e].map(t=>{let n=Lf(t);return(0,B.jsx)(`a`,{className:`sponsor-card sponsor-card--${e}`,href:t.url,target:`_blank`,rel:`noopener noreferrer`,children:(0,B.jsx)(`div`,{className:`sponsor-card-inner`,children:n?(0,B.jsx)(`img`,{className:`sponsor-logo`,src:n,alt:`${t.name} logo`,loading:`lazy`,style:t.logoMaxHeight?{maxHeight:t.logoMaxHeight}:void 0}):(0,B.jsx)(`div`,{className:`sponsor-logo-placeholder`,children:(0,B.jsx)(`span`,{children:t.name})})})},t.name)})})]},e)),(0,B.jsxs)(`div`,{className:`sponsors-cta`,children:[(0,B.jsx)(`h3`,{children:`Interested in sponsoring WIT?`}),(0,B.jsx)(`p`,{children:`Partner with us to connect with Melbourne's brightest women in tech. Download our prospectus or get in touch directly.`}),(0,B.jsxs)(`div`,{className:`sponsors-cta-actions`,children:[(0,B.jsx)(`a`,{href:`#`,className:`btn-primary`,children:`Download Prospectus`}),(0,B.jsx)(`a`,{href:`#`,className:`btn-ghost`,children:`Contact Us`})]})]})]})})}function zf(){return(0,B.jsx)(Rf,{})}var Bf={total:1,pageSize:100,page:1,events:[{_id:`6a74876799fb38d1a1f2f4df`,location:`AU`,currency:`AUD`,name:`Testing 101: Breaking the Bank with Airwallex`,sharingDescription:`Interactive workshop with WIT and Airwallex!`,slug:`testing-101-breaking-the-bank-with-airwallex`,userId:`gIfF5fsrEROvycbdClDvlBusvhB2`,organiserId:`65e564d22c23899b20ad7639`,tagIds:[],classification:{type:`classTrainingOrWorkshop`,category:`scienceAndTechnology`},public:!0,published:!0,suspendSales:!1,markedAsSoldOut:!1,startDate:`2026-08-19T07:30:00.000Z`,endDate:`2026-08-19T09:30:00.000Z`,dates:[{_id:`6a74876799fb38d1a1f2f4e6`,startDate:`2026-08-19T07:30:00.000Z`,endDate:`2026-08-19T09:30:00.000Z`,disabled:!1,deleted:!1}],timezone:`Australia/Melbourne`,totalCapacity:40,eventLocation:{type:`custom`,venueName:`Room 217, Kwong Lee Dow Building (Building 263)`,address:`234 Queensberry St, Parkville VIC 3053`,latLng:[],addressComponents:[]},ticketTypes:[{_id:`6a74876799fb38d1a1f2f4ef`,name:`General Admission`,price:0,quantity:40,disabled:!1,deleted:!1,isDonation:!1,hiddenOptions:{_id:`6a74876799fb38d1a1f2f4ee`,hidden:!1,when:`always`,ticketIds:[]}}],packagedTickets:[],additionalQuestions:[{_id:`6a7489513c95e66e6ba30ea8`,createdAt:`2026-08-06T13:17:34.655Z`,updatedAt:`2026-08-06T13:17:34.655Z`,question:`What is your course? (e.g. BSci)`,required:!0,perOrder:!1,disabled:!1},{_id:`6a74893b3c95e66e6ba30ea7`,createdAt:`2026-08-06T13:17:34.655Z`,updatedAt:`2026-08-06T13:17:34.655Z`,question:`What is your student number? (N/A if not Unimelb)`,required:!0,perOrder:!1,disabled:!1}],paymentOptions:{refundSettings:{refundPolicy:``,customRefundPolicy:``}},affiliateCodes:[],pricing:{minimumPrice:0,maximumPrice:0},isArchived:!1,keywords:[],eventModules:[{component:`richtext`,moduleType:`RichText`,props:{title:`Description`,content:`<p>Every piece of software is rigorously tested before it reaches you 🫵.\xA0 <strong>But what exactly is software testing? </strong>🙋‍♀️<br /><br />Join <strong>WIT and Airwallex </strong>for an interactive workshop where you’ll learn from real engineers how to write unit tests, and build valuable industry skills. <br /><br />Then, put your knowledge to the test in a mini competition (there's prizes up for grabs 👀)<br /><br /><strong>Can you catch all the bugs? </strong></p><p></p>`},children:[],isEventDescription:!0,_id:`6a74891441514d08b15c9ecc`}],createdAt:`2026-08-06T13:08:55.771Z`,updatedAt:`2026-08-09T15:20:18.560Z`,bannerImage:{url:`https://images.humanitix.com/i/8564bc96-c56d-4af1-8e8d-d3359dc5b17d.png@original`},publishedAt:`2026-08-06T13:18:30.194Z`,description:`<p>Every piece of software is rigorously tested before it reaches you 🫵.\xA0 <strong>But what exactly is software testing? </strong>🙋‍♀️<br /><br />Join <strong>WIT and Airwallex </strong>for an interactive workshop where you’ll learn from real engineers how to write unit tests, and build valuable industry skills. <br /><br />Then, put your knowledge to the test in a mini competition (there's prizes up for grabs 👀)<br /><br /><strong>Can you catch all the bugs? </strong></p><p></p>`,url:`https://events.humanitix.com/testing-101-breaking-the-bank-with-airwallex`}]},Vf={classTrainingOrWorkshop:`Workshops`,seminarOrTalk:`Workshops`,meetingOrNetworkingEvent:`Networking`,conference:`Networking`,convention:`Networking`,tradeShowConsumerShowOrExpo:`Networking`,partyOrSocialGathering:`Social Events`,festivalOrFair:`Social Events`,dinnerOrGala:`Social Events`,concertOrPerformance:`Social Events`,screening:`Social Events`,tour:`Social Events`,campTripOrRetreat:`Social Events`,attraction:`Social Events`,rally:`Social Events`,other:`Other`,gameOrCompetition:`Competitions`,tournament:`Competitions`,raceOrEnduranceEvent:`Competitions`},Hf=Bf.events.map(e=>({name:e.name,date:e.startDate,caption:e.sharingDescription,image:e.bannerImage.url,humanitixUrl:e.url,location:e.eventLocation.address,format:Vf[e.classification.type]||`Other`})),Uf=[{name:`Workshops`,description:`Hands-on sessions that help members build practical confidence with tools, code, and technical problem solving.`},{name:`Networking`,description:`Industry mixers and sponsor-led events designed to make meeting people in tech feel approachable and useful.`},{name:`Social Events`,description:`Low-pressure community events that help members make friends, settle in, and feel part of something bigger.`},{name:`Competitions`,description:`Challenge-based events that bring problem solving, teamwork, and a little bit of healthy pressure into the mix.`},{name:`Other`,description:`Events that don’t fit neatly into the above categories, but are still worth attending.`}],Wf={upcoming:{badge:`Coming up`,title:`Upcoming Events`,emptyState:`No upcoming events yet.`},past:{badge:`From earlier this year`,title:`Past Events`,emptyState:`No past events yet.`}},Gf=new Intl.DateTimeFormat(`en-AU`,{day:`numeric`,month:`long`,year:`numeric`});function Kf(e){return new Date(e).getTime()}function qf(e){return Gf.format(new Date(e))}function Jf(){let[e,t]=(0,x.useState)(`upcoming`),n=new Date;n.setHours(0,0,0,0);let r=n.getTime(),i=Hf.filter(e=>Kf(e.date)>=r).sort((e,t)=>Kf(e.date)-Kf(t.date)),a={upcoming:i,past:Hf.filter(e=>Kf(e.date)<r).sort((e,t)=>Kf(t.date)-Kf(e.date))}[e],o=Wf[e],s=i[0]??Hf[0];return(0,B.jsx)(`section`,{className:`events-page`,children:(0,B.jsxs)(`div`,{className:`events-page-inner`,children:[(0,B.jsxs)(`section`,{className:`events-hero`,children:[(0,B.jsx)(`div`,{className:`events-hero-media-bleed`,children:(0,B.jsx)(`div`,{className:`events-hero-media-card`,children:s.image?(0,B.jsx)(`img`,{src:s.image,alt:s.name,loading:`lazy`}):(0,B.jsx)(`div`,{className:`events-hero-media-placeholder`,"aria-hidden":`true`,children:(0,B.jsx)(`span`,{children:s.name})})})}),(0,B.jsxs)(`div`,{className:`events-hero-content`,children:[(0,B.jsxs)(`div`,{className:`events-hero-intro`,children:[(0,B.jsx)(`p`,{className:`events-hero-kicker`,children:`Events at WiT`}),(0,B.jsxs)(`h2`,{className:`events-hero-title`,children:[`Workshops, socials, and flagship moments that make the club feel `,(0,B.jsx)(`em`,{children:`alive`}),`.`]}),(0,B.jsx)(`p`,{className:`events-hero-lead`,children:`Our calendar mixes technical learning, community-building, and industry connection. Across the semester we run events that help members build confidence, meet new people, and feel more at home in tech.`})]}),(0,B.jsxs)(`div`,{className:`events-hero-types`,children:[(0,B.jsx)(`p`,{className:`events-hero-types-label`,children:`What We Run`}),(0,B.jsx)(`div`,{className:`events-hero-types-list`,children:Uf.map(e=>(0,B.jsxs)(`article`,{className:`events-hero-type-row`,children:[(0,B.jsx)(`p`,{className:`events-hero-type-name`,children:e.name}),(0,B.jsx)(`p`,{className:`events-hero-type-copy`,children:e.description})]},e.name))})]})]})]}),(0,B.jsxs)(`div`,{className:`events-header`,children:[(0,B.jsx)(`p`,{className:`section-kicker`,children:`Our Events`}),(0,B.jsxs)(`h2`,{className:`section-heading`,children:[`2026 `,(0,B.jsx)(`em`,{children:`Events`})]}),(0,B.jsx)(`p`,{className:`events-lead`,children:`Check out past and upcoming events!`})]}),(0,B.jsx)(`div`,{className:`events-toggle-wrap`,children:(0,B.jsx)(`div`,{className:`events-toggle`,"aria-label":`Event view switcher`,children:[`upcoming`,`past`].map(n=>{let r=e===n;return(0,B.jsx)(`button`,{type:`button`,className:`events-toggle-button${r?` is-active`:``}`,"aria-pressed":r,onClick:()=>t(n),children:(0,B.jsx)(`span`,{className:`events-toggle-button-label`,children:n===`upcoming`?`Upcoming Events`:`Past Events`})},n)})})}),(0,B.jsxs)(`section`,{className:`events-panel`,id:`events-collection`,children:[(0,B.jsx)(`div`,{className:`events-panel-head`,children:(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`p`,{className:`events-panel-label events-panel-label--${e}`,children:o.badge}),(0,B.jsx)(`h3`,{className:`events-panel-title`,children:o.title})]})}),a.length>0?(0,B.jsx)(`div`,{className:`events-grid`,children:a.map(t=>(0,B.jsxs)(`article`,{className:`club-event-card club-event-card--${e}`,children:[(0,B.jsx)(`div`,{className:`club-event-media`,children:t.image?(0,B.jsx)(`img`,{src:t.image,alt:t.name,loading:`lazy`}):(0,B.jsx)(`div`,{className:`club-event-media-placeholder`,"aria-hidden":`true`,children:(0,B.jsx)(`span`,{children:t.name})})}),(0,B.jsxs)(`div`,{className:`club-event-body`,children:[(0,B.jsx)(`p`,{className:`club-event-date`,children:qf(t.date)}),(0,B.jsx)(`h4`,{className:`club-event-title`,children:t.name}),(0,B.jsx)(`p`,{className:`club-event-caption`,children:t.caption}),e===`upcoming`&&t.humanitixUrl?(0,B.jsx)(`a`,{className:`btn-primary club-event-link`,href:t.humanitixUrl,target:`_blank`,rel:`noreferrer`,children:`Register Now`}):null]})]},`${t.name}-${t.date}`))}):(0,B.jsx)(`div`,{className:`events-empty-state`,children:(0,B.jsx)(`p`,{children:o.emptyState})})]},e)]})})}function Yf(){return(0,B.jsx)(Jf,{})}var Xf=[{name:`Name Here`,role:`President`,blurb:`Add a short intro about the President here, including how they shape the club direction and member experience.`},{name:`Name Here`,role:`Vice President`,blurb:`Use this space for a quick overview of how the Vice President supports operations, planning, and team coordination.`},{name:`Name Here`,role:`Secretary`,blurb:`This can introduce the person handling club administration, finance, and the behind-the-scenes structure of the society.`},{name:`Name Here`,role:`Treasurer`,blurb:`This can introduce the person handling club administration, finance, and the behind-the-scenes structure of the society.`}],Zf=[{name:`Name Here`,role:`P&C Director`,blurb:`Placeholder copy for the person leading workshops, socials, and the wider events calendar.`},{name:`Name Here`,role:`Promotions Director`,blurb:`Placeholder copy for the person managing sponsor and industry relationships.`},{name:`Name Here`,role:`Media Director`,blurb:`Placeholder copy for the person shaping social media, branding, and outreach.`},{name:`Name Here`,role:`Industry Director`,blurb:`Placeholder copy for the person leading workshops, socials, and the wider events calendar.`},{name:`Name Here`,role:`Events Director`,blurb:`Placeholder copy for the person leading workshops, socials, and the wider events calendar.`},{name:`Name Here`,role:`Education Director`,blurb:`Placeholder copy for the person leading workshops, socials, and the wider events calendar.`},{name:`Name Here`,role:`IT Director`,blurb:`Placeholder copy for the person leading workshops, socials, and the wider events calendar.`}],Qf=[{name:`General`,description:`General officers can support culture, operations, and the wider member experience across the club.`,members:[{name:`Name Here`},{name:`Name Here`}]},{name:`Events`,description:`The events team supports planning, logistics, and delivery for workshops, socials, and flagship programs.`,members:[{name:`Name Here`},{name:`Name Here`}]},{name:`Media`,description:`This team supports content, social media, and design so members hear about what the club is building.`,members:[{name:`Name Here`},{name:`Name Here`}]},{name:`Promotions`,description:`The promotions team supports outreach, partnerships, and sponsor-facing work for the society.`,members:[{name:`Name Here`},{name:`Name Here`}]},{name:`IT`,description:`The IT team supports the website, systems, and technical infrastructure behind the club.`,members:[{name:`Name Here`},{name:`Name Here`},{name:`Name Here`},{name:`Name Here`}]},{name:`Industry`,description:`Industry officers support outreach, partnerships, and sponsor-facing work for the society.`,members:[{name:`Name Here`},{name:`Name Here`}]}];function $f(e){return e.split(/[\s/]+/).filter(Boolean).slice(0,2).map(e=>e[0]?.toUpperCase()??``).join(``)}function ep({member:e}){return(0,B.jsxs)(`article`,{className:`leadership-card`,tabIndex:0,children:[(0,B.jsx)(`div`,{className:`leadership-card-photo`,"aria-hidden":`true`}),(0,B.jsx)(`div`,{className:`leadership-card-overlay`,children:(0,B.jsx)(`p`,{className:`leadership-card-copy`,children:e.blurb})}),(0,B.jsxs)(`div`,{className:`leadership-card-body`,children:[(0,B.jsx)(`p`,{className:`leadership-card-role`,children:e.role}),(0,B.jsx)(`h4`,{className:`leadership-card-name`,children:e.name})]})]})}function tp({member:e}){return(0,B.jsxs)(`article`,{className:`officer-card`,children:[(0,B.jsx)(`div`,{className:`officer-card-avatar`,children:e.photoUrl?(0,B.jsx)(`img`,{src:e.photoUrl,alt:e.name,loading:`lazy`}):(0,B.jsx)(`span`,{"aria-hidden":`true`,children:$f(e.name)})}),(0,B.jsx)(`div`,{className:`officer-card-body`,children:(0,B.jsx)(`h4`,{className:`officer-card-name`,children:e.name})})]})}function np(){return(0,B.jsx)(`section`,{className:`about-page`,children:(0,B.jsxs)(`div`,{className:`about-page-inner`,children:[(0,B.jsxs)(`header`,{className:`about-header`,children:[(0,B.jsx)(`p`,{className:`section-kicker`,children:`About Us`}),(0,B.jsxs)(`h2`,{className:`section-heading`,children:[`Building a stronger `,(0,B.jsx)(`em`,{children:`community`}),` in tech`]}),(0,B.jsx)(`p`,{className:`about-lead`,children:`We are a student-led club committed to empowering women and gender-diverse students with practical technical skills and industry experience to help successful careers in tech.`})]}),(0,B.jsxs)(`section`,{className:`about-team-section`,children:[(0,B.jsxs)(`div`,{className:`about-team-header`,children:[(0,B.jsx)(`p`,{className:`about-team-kicker`,children:`Leadership`}),(0,B.jsx)(`h3`,{className:`about-team-title`,children:`Executives`})]}),(0,B.jsx)(`div`,{className:`leadership-grid leadership-grid--executives`,children:Xf.map(e=>(0,B.jsx)(ep,{member:e},e.role))})]}),(0,B.jsxs)(`section`,{className:`about-team-section`,children:[(0,B.jsxs)(`div`,{className:`about-team-header`,children:[(0,B.jsx)(`p`,{className:`about-team-kicker`,children:`Leadership`}),(0,B.jsx)(`h3`,{className:`about-team-title`,children:`Directors`})]}),(0,B.jsx)(`div`,{className:`leadership-grid leadership-grid--directors`,children:Zf.map(e=>(0,B.jsx)(ep,{member:e},e.role))})]}),(0,B.jsxs)(`section`,{className:`about-team-section`,children:[(0,B.jsxs)(`div`,{className:`about-team-header`,children:[(0,B.jsx)(`p`,{className:`about-team-kicker`,children:`Subcommittee`}),(0,B.jsx)(`h3`,{className:`about-team-title`,children:`Officers`})]}),(0,B.jsx)(`div`,{className:`subcommittee-groups`,children:Qf.map(e=>(0,B.jsxs)(`section`,{className:`subcommittee-group`,children:[(0,B.jsxs)(`div`,{className:`subcommittee-group-header`,children:[(0,B.jsx)(`h4`,{className:`subcommittee-group-title`,children:e.name}),(0,B.jsx)(`p`,{className:`subcommittee-group-copy`,children:e.description})]}),(0,B.jsx)(`div`,{className:`officer-grid`,children:e.members.map((t,n)=>(0,B.jsx)(tp,{member:t},`${e.name}-${t.name}-${n}`))})]},e.name))})]})]})})}function rp(){return(0,B.jsx)(np,{})}function ip(){return(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(Ln,{}),(0,B.jsx)(`main`,{children:(0,B.jsxs)(Et,{children:[(0,B.jsx)(wt,{path:`/`,element:(0,B.jsx)(_f,{})}),(0,B.jsx)(wt,{path:`/about`,element:(0,B.jsx)(rp,{})}),(0,B.jsx)(wt,{path:`/sponsors`,element:(0,B.jsx)(zf,{})}),(0,B.jsx)(wt,{path:`/events`,element:(0,B.jsx)(Yf,{})})]})}),(0,B.jsx)(zn,{})]})}(0,Fn.createRoot)(document.getElementById(`root`)).render((0,B.jsx)(x.StrictMode,{children:(0,B.jsx)(mn,{children:(0,B.jsx)(ip,{})})}));